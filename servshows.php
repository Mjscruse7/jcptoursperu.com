...
<head>
	...
	<title><?php echo $lang["srv-shows"]; ?>- <?php echo $lang["name-jcp"]; ?></title>
		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav"><a href="index.php"><?php echo $lang["menu-inicio"]; ?></a> <span class="lnr lnr-arrow-right"></span> <a href="servshows.php"><?php echo $lang["srv-shows"]; ?></a>
					</p>
				</div>
			</div>
		</div>
					...
					<div class="single-post row">
						<div class="col-lg-12">
							<div class="feature-img">
								<img class="img-fluid" src="img/specialservices/feature-img2.jpg" alt="">
							</div>
						</div>
						...
						<div class="col-lg-9 col-md-9">
							<h3 class="mt-20 mb-20"><?php echo $lang["srv-shows"]; ?></h3>
							<p class="excert">
								<?php echo $lang["srvshows-description-one"]; ?>


							</p>
							<p class="excert">
								<?php echo $lang["srvshows-description-two"]; ?>
						...
						<div class="col-lg-12">
							<div class="quotes">
								<?php echo $lang["srvshows-description-tree"]; ?>

							</div>
							<div class="row mt-30 mb-30">
								<div class="col-6">
									<img class="img-fluid" src="img/specialservices/post-img3.jpg" alt="">
								</div>
								<div class="col-6">
									<img class="img-fluid" src="img/specialservices/post-img4.jpg" alt="">
								</div>
								<br>
