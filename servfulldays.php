...
<head>
	...
	<meta property="og:title" content="JCP Perú Tours | Servicio tours full days Lima - Perú." />
	...
	<!-- Meta Keyword -->
	<meta name="keywords" content="turismo, travel, gastronomía, tours, tours, full days, full day Lima, tours lima, ciudad de lima, tours peru">
	<!-- meta character set -->
	<meta charset="UTF-8">
	<!-- Site Title -->
	...
	<title><?php echo $lang["srv-fulldays"]; ?>- <?php echo $lang["name-jcp"]; ?></title>
		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav"><a href="index.php"><?php echo $lang["menu-inicio"]; ?></a> <span class="lnr lnr-arrow-right"></span> <a href="servfulldays.php"><?php echo $lang["srv-fulldays"]; ?></a>
					</p>
				</div>
			</div>
		</div>
					...
					<div class="single-post row">
						<div class="col-lg-12">
							<div class="feature-img">
								<img class="img-fluid" src="img/specialservices/feature-img3.jpg" alt="">
							</div>
						</div>
						...
						<div class="col-lg-9 col-md-9">
							<h3 class="mt-20 mb-20"><?php echo $lang["srv-fulldays"]; ?></h3>
							<p class="excert">

								<?php echo $lang["srvfulldays-description"]; ?>
						...
						<div class="col-lg-12">
							<div class="quotes">
								<?php echo $lang["srvfulldays-description-two"]; ?>
							</div>
							<div class="row mt-30 mb-30">
								<div class="col-6">
									<img class="img-fluid" src="img/specialservices/post-img5.jpg" alt="">
								</div>
								<div class="col-6">
									<img class="img-fluid" src="img/specialservices/post-img6.jpg" alt="">
								</div>
								<br>
				...
				<div class="col-lg-4 sidebar-widgets">
					<div class="widget-wrap">
						...
						<div class="single-sidebar-widget post-category-widget">
							<h4 class="category-title"><?php echo $lang["title-widgets"]; ?></h4>
							<ul class="cat-list">
								<li>
									<a href="packages.php#caral" class="d-flex justify-content-between">
										<p>Caral</p>
									</a>
								</li>
								<li>
									<a href="packages.php#paracas" class="d-flex justify-content-between">
										<p>Paracas - Portón - Huacachina</p>

									</a>
								</li>
								<li>
									<a href="packages.php#nazca" class="d-flex justify-content-between">
										<p>Paracas - Nazca</p>
							...
							<h4 class="category-title"><a href="packages.php" class="genric-btn primary-border circle"><?php echo $lang["see-more"]; ?></a></h4>
