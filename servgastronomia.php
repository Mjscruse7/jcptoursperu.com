...
<head>
	...
	<title><?php echo $lang["srv-cousine"]; ?>- <?php echo $lang["name-jcp"]; ?></title>
		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav"><a href="index.php"><?php echo $lang["menu-inicio"]; ?></a> <span class="lnr lnr-arrow-right"></span> <a href="servgastronomia.php"><?php echo $lang["srv-cousine"]; ?></a>
					</p>
				</div>
			</div>
		</div>
					...
					<div class="single-post row">
						<div class="col-lg-12">
							<div class="feature-img">
								<img class="img-fluid" src="img/specialservices/feature-img1.jpg" alt="">
							</div>
						</div>
						...
						<div class="col-lg-9 col-md-9">
							<h3 class="mt-20 mb-20"><?php echo $lang["srv-cousine"]; ?></h3>
							<p class="excert">
								<?php echo $lang["srvcousine-description-one"]; ?>

							</p>
							<p class="excert">
								<?php echo $lang["srvcousine-description-two"]; ?>
						...
						<div class="col-lg-12">
							<div class="quotes">
								<?php echo $lang["srvcousine-description-tree"]; ?>
							</div>
							<div class="row mt-30 mb-30">
								<div class="col-6">
									<img class="img-fluid" src="img/specialservices/post-img1.jpg" alt="">
								</div>
								<div class="col-6">
									<img class="img-fluid" src="img/specialservices/post-img2.jpg" alt="">
								</div>
								<br>
				...
				<div class="col-lg-4 sidebar-widgets">
					<div class="widget-wrap">
						...
						<div class="single-sidebar-widget post-category-widget">
							<h4 class="category-title"><?php echo $lang["title-widgets-two"]; ?></h4>
							<ul class="cat-list">
								<li>
									<a href="tours.php#surquillo" class="d-flex justify-content-between">
										<p style="text-transform: uppercase;">SURQUILLO - <?php echo $lang["srv-cousine"]; ?> </p>
									</a>
								</li>
								<li>
									<a href="tours.php#fuentes" class="d-flex justify-content-between">
										<p style="text-transform: uppercase;"><?php echo $lang["tour-two"]; ?>- <?php echo $lang["srv-shows"]; ?></p>

									</a>
								</li>
								<li>
									<a href="tours.php#palomino" class="d-flex justify-content-between">
										<p><?php echo $lang["tour-tree"]; ?> - TOUR</p>

									</a>
								</li>
								<li>
									<a href="tours.php#lima" class="d-flex justify-content-between">
										<p><?php echo $lang["tour-four"]; ?> - CITY TOUR</p>

									</a>
								</li>
								<li>
									<a href="tours.php#pachacamac" class="d-flex justify-content-between">
										<p>PACHACAMAC - CITY TOUR</p>

									</a>
								</li>
								<li>
									<a href="tours.php#paso" class="d-flex justify-content-between">
										<p>DPASO HACIENDA - CITY TOUR</p>
							...
							<h4 class="category-title"><a href="tours.php" class="genric-btn primary-border circle"><?php echo $lang["see-more"]; ?></a></h4>
